...
TEST(lrp_elixir_s1_local_call) {
    static const LRP_File f[] = {{"accounts.ex", "defmodule Accounts do\n"
...
TEST(lrp_elixir_s2_qualified_alias) {
    static const LRP_File f[] = {{"outer.ex", "defmodule Outer do\n"
                                              "  defmodule Inner do\n"
                                              "    def helper(x), do: x\n"
                                              "  end\n"
                                              "  alias Outer.Inner\n"
...
TEST(lrp_elixir_s4_pipe_chain) {
    static const LRP_File f[] = {{"pipex.ex", "defmodule Pipex do\n"
                                              "  def double(x), do: x * 2\n"
...
TEST(lrp_elixir_s5_capture) {
    static const LRP_File f[] = {{"capx.ex", "defmodule Capx do\n"
                                             "  def double(x), do: x * 2\n"
...
TEST(lrp_elixir_s6_protocol_impl) {
    static const LRP_File f[] = {{"proto.ex", "defmodule Helpers do\n"
                                              "  def measure(x), do: x\n"
                                              "end\n"
...
TEST(lrp_elixir_s8_nested_sibling) {
    static const LRP_File f[] = {{"app.ex", "defmodule App do\n"
                                            "  defmodule Repo do\n"
                                            "    def get(id), do: id\n"
                                            "  end\n"
...
TEST(lrp_elixir_s9_stdlib_collision) {
    static const LRP_File f[] = {{"routerx.ex", "defmodule Routerx do\n"
    ...
    if (calls != 0) {
        fprintf(stderr,
                "  [LRP] elixir/S9/stdlib_collision FAIL calls=%d expected 0 "
...
TEST(lrp_elixir_s14_behaviour_override) {
    static const LRP_File f[] = {{"serverx.ex", "defmodule Serverx do\n"
                                                "  use GenServer\n"
    ...
    if (inherits < 1 || overrides < 2) {
        fprintf(stderr,
                "  [LRP] elixir/S14/behaviour FAIL inherits=%d overrides=%d "
                "(expected >=1 / >=2)\n",
                inherits, overrides);
...
TEST(lrp_elixir_s12_dep_collision) {
    static const LRP_File f[] = {{"webx.ex", "defmodule Webx do\n"
                                             "  def get(a), do: a\n"
                                             "end\n"},
...
TEST(lrp_elixir_s11_erlang_collision) {
    static const LRP_File f[] = {{"storex.ex", "defmodule Storex do\n"
...
TEST(lrp_elixir_s10_imports_resolution) {
    ...
    if (imports != 1) {
        fprintf(stderr,
                "  [LRP] elixir/S10/imports_resolution FAIL imports=%d expected 1 "
